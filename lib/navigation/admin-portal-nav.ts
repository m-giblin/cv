...
export const ADMIN_PORTAL_NAV_GROUPS: AdminPortalNavGroup[] = [
  {
    ...
    items: [
      ...
      { id: "competencies", href: "/admin?tab=competencies", label: "Competencies", tab: "competencies" },
      { id: "content-portal", href: "/admin?tab=content-portal", label: "Content Portal", tab: "content-portal" },
      { id: "reviews", href: "/admin?tab=reviews", label: "Reviews", tab: "reviews" },
