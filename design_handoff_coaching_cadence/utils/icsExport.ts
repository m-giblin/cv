// ============================================================
// utils/icsExport.ts — Generate .ics calendar invite
// ============================================================
...
export function generateICS(se: SEProfile): void {
  ...
  const ics = [
    ...
    // Note: production Microsoft Graph API approach adds Teams link automatically
    // Use POST /me/events with onlineMeeting: { provider: 'teamsForBusiness' }
    `DESCRIPTION:${desc.replace(/\n/g, '\\n')}`,
    'LOCATION:Microsoft Teams',
    'STATUS:TENTATIVE',
    `ORGANIZER:MAILTO:manager@sailpoint.com`,
    // Add attendee when you have se.email populated:
