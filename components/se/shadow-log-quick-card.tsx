...
export function ShadowLogQuickCard({ shadowStep }: { shadowStep?: PlanStep }) {
 ...
 <textarea
 className="mt-3 w-full border border-stone-200 bg-white px-3 py-2 text-sm text-stone-800 placeholder:text-stone-400"
 ...
 />
 <button
 className="mt-2 border border-[#0033a1]/25 bg-white px-3 py-1.5 text-xs font-semibold text-[#0033a1] disabled:opacity-50"
 disabled={saving}
