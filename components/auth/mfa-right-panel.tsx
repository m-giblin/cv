        ...
        >
          ...
          <div className="rounded-[10px] border border-[#e2eaf5] bg-[#f8fafd] p-[13px_15px]">
            <p className="text-[12px] leading-[1.65] text-[#475569]">
              <strong className="font-semibold text-[#0a1628]">Can&apos;t access your authenticator?</strong>
              <br />
              Contact your manager or IT admin to reset MFA. New to MFA? You&apos;ll be prompted to enroll on first
              sign-in.
            </p>
          </div>
        </div>
