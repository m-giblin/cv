    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <span className="sp-logo-mark mx-auto flex h-14 w-14 items-center justify-center rounded-2xl text-xl font-bold text-white">
            SE
          </span>
        ...
        <div className="sp-card-glow rounded-3xl border border-white/80 bg-white/95 p-6 backdrop-blur-sm md:p-8">
          {children}
        </div>
