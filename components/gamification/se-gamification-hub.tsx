...
export function SeGamificationHub({ scorecard }: { scorecard: SeScorecard }) {
 ...
 return (
 <div className="mb-5 overflow-hidden border border-amber-200/60 bg-gradient-to-br from-amber-50/80 via-white to-[#e8f2fc]/40 ">
 ...
 <span className="bg-white px-2 py-1 text-[10px] font-semibold text-slate-600 " key={row.label}>
