...
export function MasterCorpusAdmin() {
 ...
 <div>
 <h1 className="font-display text-xl font-extrabold text-[#0D0E12]">Master Corpus</h1>
 ...
 <input
 className="h-9 max-w-xs flex-1 border border-[#E2DFD9] px-3 text-xs outline-none focus:border-[#0071ce]"
 ...
 <p className="px-5 py-8 text-center text-sm text-[#A09D98]">No assets match your search.</p>
 ) : (
 filtered.map((asset) => {
 ...
 <p className="mt-[1px] text-[10px] text-[#A09D98]">{asset.url}</p>
 </div>
 <span
 className="w-fit font-mono text-[8px] uppercase tracking-[0.08em] px-[8px] py-[2px] text-[9.5px] font-bold capitalize"
 ...
 <span className="text-[11.5px] text-[#3D3C38]">v{asset.version}</span>
