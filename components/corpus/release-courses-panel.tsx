...
type AssigneeRow = Profile & { alreadyEnrolled: boolean };
 ...
 <select
 className="h-10 w-full border border-stone-200 px-3 text-sm"
 ...
 {courses.map((course) => (
 <li className="flex flex-wrap items-center justify-between gap-2 border border-stone-200 p-3 text-sm" key={course.id}>
 <div>
 ...
 {assignCourse ? (
 <div className="border border-stone-200 bg-stone-50/80 p-4">
