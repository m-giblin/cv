...
export function CorpusFeedbackAdmin() {
 ...
 <div>
 <p className="text-[12.5px] font-bold text-[#0D0E12]">SE feedback queue</p>
 <p className="text-[10.5px] text-[#A09D98]">Questions SEs asked in ISC Lab that need SME answers</p>
 </div>
 ...
 <p className="px-[18px] py-8 text-center text-sm text-[#A09D98]">No open feedback — you&apos;re caught up.</p>
 ) : (
 items.map((item) => {
 ...
 <p className="mb-[3px] text-[12px] font-semibold text-[#3D3C38]">
