  ...
  return (
    <div className="animate-[fadeUp_0.2s_ease-out] space-y-3.5">
      {pendingBriefs.length > 0 ? (
        <div className="flex flex-wrap items-center gap-2.5 rounded-[10px] border border-[rgba(0,113,206,0.15)] bg-[#f0f7ff] px-3.5 py-2.5">
            ...
            <button
              className={cn(
                ...
                active
                  ...
                  : "border border-[#e2eaf5] bg-white text-[#475569] hover:bg-slate-50",
              )}
              key={item.id}
      ...
      {mode === "account_prep" ? (
        <div className="flex flex-wrap items-end gap-2">
          <div className="min-w-[200px] flex-1 max-w-xs">
            <label className="mb-1 block text-[10px] font-bold uppercase tracking-wide text-[#64748b]">
              Account name
            </label>
            <Input
      ...
      <div className="overflow-hidden rounded-[13px] border-[1.5px] border-[#e2eaf5] bg-white shadow-[0_2px_12px_rgba(0,20,58,0.05)]">
          ...
          {history.length === 0 ? (
            ...
            history.map((turn, index) => (
              ...
              >
                ...
                <div
                  className={cn(
                    "max-w-[84%] rounded-[12px] border px-[11px] py-[10px] text-[12.5px] leading-[1.65]",
                    turn.role === "user"
                      ? "order-1 border-[#e2eaf5] bg-white text-[#1e293b]"
                      : "border-[#e2eaf5] bg-[#f8fafd] text-[#1e293b]",
                  )}
                >
                  <p className="whitespace-pre-wrap">{turn.content}</p>
                  {turn.role === "assistant" && turn.sources && turn.sources.length > 0 ? (
                    <div className="mt-[10px] border-t border-black/[0.08] pt-[8px]">
                      <p className="mb-[6px] flex items-center gap-[4px] text-[9.5px] font-bold uppercase tracking-[0.07em] text-[#94a3b8]">
                      ...
                      <div className="mb-[7px] flex flex-wrap gap-[5px]">
                        {turn.sources.map((source) => {
                          ...
                          return (
                            <a
                              className="rounded-[7px] border border-[#e2eaf5] bg-white px-[9px] py-[4px]"
                              href={source.url}
                            ...
                            >
                              ...
                              <p className="mt-[1px] text-[9px] text-[#94a3b8]">
        ...
        <form
          className="flex gap-2 border-t border-[#f1f5f9] px-4 py-3"
          onSubmit={(event) => {
