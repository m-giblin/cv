...
export function TeamReadinessHeatmap({
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-sp-blue/10 bg-white p-4">
              ...
              {COMPETENCIES.map((competency) => {
                ...
                return (
                  <td className="p-1 text-center" key={competency}>
                    <span
                      className={`inline-flex h-8 w-8 items-center justify-center rounded-lg text-[10px] font-bold ${heatColor(score)}`}
