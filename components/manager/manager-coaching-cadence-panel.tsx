...
export function ManagerCoachingCadencePanel({
 ...
 <p className="mt-2 text-[11.5px] text-[#6B6860]">No SEs need coaching touchpoints right now.</p>
 </div>
 );
 }
 ...
 return (
 <div className="overflow-hidden border border-[#E2DFD9] bg-white" key={row.profileId}>
 ...
 <button
 className="text-left text-[13px] font-bold text-[#0D0E12] hover:underline"
 ...
 <span className="text-[10px] capitalize text-[#A09D98]">{levelById[row.profileId] ?? "SE"}</span>
 </div>
 ...
 {points.length > 0 ? (
 <div className="border-t border-[#ECEAE6] bg-[#F9F8F6] p-[12px_18px_14px]">
 <p className="mb-[7px] text-[10px] font-bold uppercase tracking-[0.07em] text-[#6B6860]">
