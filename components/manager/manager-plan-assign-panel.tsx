  ...
  return (
    <Card className="scroll-mt-6 border-0 bg-transparent shadow-none" id={compact ? undefined : "onboarding-plans"}>
      ...
      <div className="space-y-4 px-0 pb-0">
        ...
        {selectedTemplate ? (
          <div className="rounded-xl border border-sp-blue/10 bg-sp-blue-soft/15 p-4">
        ...
        <form className="space-y-3 border-t border-[#e2eaf5] pt-4" onSubmit={handleAssign}>
          ...
          <div className={`grid gap-3 ${compact ? "grid-cols-1" : "sm:grid-cols-2"}`}>
            <label className="block space-y-1.5 text-sm">
              ...
              <select
                className="h-10 w-full rounded-xl border border-sp-blue/15 bg-white px-3"
          ...
          <div className={`grid gap-3 ${compact ? "grid-cols-1" : "sm:grid-cols-2"}`}>
            ...
            <label className="block space-y-1.5 text-sm">
              ...
              <div className="flex h-10 items-center gap-2 rounded-xl border border-sp-blue/10 bg-sp-blue-soft/20 px-3 text-sm text-sp-navy-muted">
