...
export function ManagerBuyerEngagementPanel() {
 ...
 <div className="border border-sp-blue/10 bg-sp-blue-soft/20 p-3 text-center">
 ...
 rows.map((row, index) => (
 <div className="flex flex-wrap items-center justify-between gap-2 border border-sp-blue/10 px-3 py-2 text-xs" key={`${row.createdAt}-${index}`}>
