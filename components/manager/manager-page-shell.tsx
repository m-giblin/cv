...
function ManagerDevelopmentSection({
  ...
  return (
    <div className="space-y-[16px]">
      {duePlanAlert ? (
        <div
          className="mb-[16px] flex items-center justify-between gap-[16px] rounded-xl p-[14px_18px]"
        ...
        >
          ...
          <button
            className="inline-flex shrink-0 items-center rounded-lg px-[18px] py-[9px] text-[12.5px] font-semibold text-white"
      ...
      <div className="space-y-[12px]">
        {org.map((profile) => {
          ...
          return (
            <div className="overflow-hidden rounded-xl border border-[#e2eaf5] bg-white" key={profile.id}>
              <div className="flex items-center gap-[12px] border-b border-[#f1f5f9] p-[14px_18px]">
                <div
                ...
                <div className="min-w-0 flex-1">
                  <div className="mb-[2px] flex items-center gap-[7px]">
                    <span className="text-[13px] font-bold text-[#0a1628]">{profile.fullName}</span>
                    {alert ? (
                      <span
              ...
              {plan ? (
                <div className="grid grid-cols-4">
                  {(["Q1", "Q2", "Q3", "Q4"] as const).map((quarter) => (
                    <div className="border-r border-[#f1f5f9] p-[11px_14px] last:border-r-0" key={quarter}>
                      <p
                      ...
                      <p className="text-[11px] leading-[1.5] text-[#475569]">{quarterDesc(plan, quarter)}</p>
                    </div>
                  ))}
                </div>
              ) : null}
      ...
      {org.length === 0 ? (
        <p className="text-[12.5px] text-[#94a3b8]">No team members in your org.</p>
      ) : null}
    </div>
  );
}
