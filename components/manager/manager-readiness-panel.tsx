...
export function ManagerReadinessPanel() {
 ...
 <div className="border border-[#E2DFD9] bg-white p-[16px_18px]" key={comp.name}>
 <div className="mb-[10px] flex items-center justify-between">
 <p className="text-[12.5px] font-bold text-[#0D0E12]">{comp.name}</p>
 ...
 <span className="text-[11px] text-[#3D3C38]">{row.name}</span>
 ...
 <p className="mb-[4px] text-[12.5px] font-bold text-[#0D0E12]">
 Recommended coaching focus this week
 </p>
 <p className="mb-[12px] text-[11.5px] text-[#6B6860]">Based on lowest team competency scores</p>
 <div className="flex flex-wrap gap-[10px]">
 <div
 className="min-w-[180px] flex-1 p-[10px_14px]"
