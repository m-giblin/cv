...
export function ObjectionPracticePanel({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col rounded-2xl border border-sp-blue/15 bg-white shadow-sm">
      <header className="flex shrink-0 items-start justify-between gap-3 border-b border-sp-blue/10 px-4 py-4">
        <div className="min-w-0">
          ...
          <p className="mt-2 rounded-xl bg-sp-blue-soft/30 px-3 py-2 text-sm leading-snug text-sp-navy-muted">
        ...
        <button
          ...
          className="shrink-0 rounded-lg p-2 text-sp-navy-muted transition hover:bg-sp-blue-soft/40 hover:text-sp-navy"
          onClick={onClose}
          type="button"
        >
          <X className="h-5 w-5" />
