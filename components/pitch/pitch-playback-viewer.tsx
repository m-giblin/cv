  ...
  return (
    <div className="rounded-xl border border-[#e2eaf5] bg-white">
      <div className="border-b border-[#f1f5f9] p-6">
        ...
        <p className="mt-1 text-sm text-[#64748b]">Peer pitch reference — study structure and delivery.</p>
      </div>
      <div className="flex justify-center px-6 pb-6 pt-4">
        <video
          className="aspect-video w-full max-w-[440px] rounded-xl border border-[#e2eaf5] object-cover"
          controls
          preload="metadata"
          src={signedUrl}
        >
