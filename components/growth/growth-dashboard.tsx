...
export function GrowthDashboard({ data }: { data: DashboardData }) {
 ...
 return (
 <div
 className={`border p-4 ${isCurrent ? "border-sp-magenta/30 bg-sp-magenta-soft/20" : "border-sp-blue/10"}`}
 key={stage.level}
 >
 ...
 <Link className="bg-sp-blue px-4 py-2 text-sm font-semibold text-white hover:bg-sp-blue-deep" href="/simulations?focus=simulation">
 Run a simulation
 </Link>
