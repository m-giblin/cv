...
export function MobilePracticeShell() {
 ...
 className="fixed bottom-0 left-0 right-0 z-40 border-t border-[#E2DFD9] bg-white/95 px-2 pb-[env(safe-area-inset-bottom)] pt-2 backdrop-blur md:hidden"
 >
 ...
 <Link
 className={cn(
 "flex min-w-[72px] flex-col items-center gap-1 px-2 py-2 text-[10px] font-semibold",
