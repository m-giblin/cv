  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#00143a] to-[#0033a1] px-4 py-10 text-white">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 space-y-6 rounded-2xl bg-white p-6 text-slate-800 shadow-xl">
          <section>
                ...
                {payload.resources.map((resource, index) => (
                  <li key={`${resource.label}-${index}`}>
                    {resource.body ? (
                      ...
                      <button
                        className="w-full rounded-xl border border-[#0033a1]/20 bg-[#e8f2fc] px-4 py-3 text-left text-sm font-semibold text-[#0033a1] hover:bg-[#dbeafe]"
